      ...
      <div className="mt-4 px-4 lg:px-[5%] mb-6">
        <div className="flex gap-1.5">
          ...
          <p className="text-primary font-light">
            {isPending ? <Skeleton className="w-28 h-6" /> : product?.category}
          </p>
        </div>
        <div className="relative mt-4">
              ...
              <div className="flex lg:col-span-9">
                {tabs.map((item, index) => (
                  <p
                    key={index}
                    className={twMerge(
                      "text-black border-b border-b-gray-100 pb-1 font-light w-full text-xs text-center lg:text-left",
          ...
          <div className="mt-3 px-2 text-primary text-xs lg:text-sm font-normal flex items-center gap-3 w-full">
            <p>Show more</p>
            <ArrowDown2 size="16" variant="Linear" className="stroke-primary" />
          </div>
        </div>
      </div>
